  ...
  return (
    <svg
      ...
      <g className="zone-group">
        ...
        <text x="145" y="113" textAnchor="middle" style={{fontSize: '9px', fill: 'rgba(255,255,255,0.7)'}}>
      ...
      <g className="zone-group">
        ...
        <text x="430" y="113" textAnchor="middle" style={{fontSize: '9px', fill: 'rgba(255,255,255,0.7)'}}>
      ...
      <g className="zone-group">
        ...
        <text x="715" y="113" textAnchor="middle" style={{fontSize: '9px', fill: 'rgba(255,255,255,0.7)'}}>
      ...
      <text x="430" y="218" textAnchor="middle" style={{fontSize: '10px', fill: 'rgba(0,0,0,0.45)', fontWeight: 500}}>
